...
import { Heart, Phone, ShieldCheck, Volume2 } from "lucide-react";
            ...
            {helplines.map((h) => (
              ...
              >
                <div>
                  ...
                  {h.note ? (
                    <div className="mt-1 text-xs text-muted">{h.note}</div>
                  ) : null}
                </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-display tracking-tight">
              ...
              <AnimatePresence>
                {running ? (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -8 }}
                    className="rounded-xl border border-rose/30 bg-white/5 p-4"
                    aria-live="polite"
                  >
                    <div className="text-sm text-muted">
                      {t("resources.safeCycle")}
                    </div>
